...
<body>
    ...
    <div class="container">
        ...
        <!-- Mensaje de rechazo -->
        <div class="message-title">Pago Rechazado</div>
        <div class="error-message">Lamentablemente, tu pago no pudo ser procesado. Intenta nuevamente o utiliza otro método de pago.</div>
